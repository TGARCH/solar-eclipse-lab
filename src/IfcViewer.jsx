...
export default function IfcViewer({ selectedId, onSelect, onState, sectionPlane, viewMode='model', siteRotation=0, gps={lat:'52.25',lon:'21'}, geoLayers={}, geoReload=0, parcel=null, solar={date:'03-21',hour:12,all:false} }) {
  ...
  return <>
    ...
    {viewMode==='site'&&sunData.map(s=><directionalLight key={s.hour} position={s.position} intensity={solar.all?.12:3.1} castShadow shadow-mapSize={solar.all?[768,768]:[2048,2048]} shadow-camera-left={-18} shadow-camera-right={18} shadow-camera-top={18} shadow-camera-bottom={-18} shadow-bias={-.0002}/>)}
    <gridHelper args={[80,80,'#bcc9ce','#e1e7e9']} position={[0,-.012,0]}/>
